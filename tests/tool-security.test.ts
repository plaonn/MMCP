    ...
    const message = {
      ...
      result: {
        tools: [
          ...
          { name: "get_mailbox_status", inputSchema: { type: "object" } },
          { name: "search_mail_actions", inputSchema: { type: "object" } },
          { name: "upsert_mail_actions", inputSchema: { type: "object" } },
          { name: "record_mail_action_candidates", inputSchema: { type: "object" } },
          { name: "record_todoist_sync_results", inputSchema: { type: "object" } },
