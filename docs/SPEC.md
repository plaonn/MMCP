...
MMCP는 읽기 전용 MVP 단계임. Streamable HTTP MCP 서버와 네이버 IMAP 조회
기능이 구현되어 있음.
...
- MCP 서버 지침과 도구 annotation에서 모든 현재 도구를 읽기 전용으로 표시함.
